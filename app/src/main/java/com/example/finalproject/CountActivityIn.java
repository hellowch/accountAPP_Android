...
public class CountActivityIn extends AppCompatActivity {
    ...
    public String[] labelName = new String[]{"投资理财", "工资", "兼职", "转账", "其他"};
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(CountActivityIn.this,"网络失败",Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
    ...
    private void setData() {
        ...
        barDataSet1.setLabel("收入金额"); // 设置标签之后，图例的内容默认会以设置的标签显示
        // 设置柱子上数据显示的格式
